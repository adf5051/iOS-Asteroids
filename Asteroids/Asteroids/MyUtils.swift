...
func randomCGPointOutsideRect(_ rect:CGRect)->CGPoint {
    let end = CGFloat(Float(arc4random()) / Float(UINT32_MAX));
    let side = CGFloat(Float(arc4random()) / Float(UINT32_MAX));
